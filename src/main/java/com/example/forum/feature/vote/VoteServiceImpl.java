...
public class VoteServiceImpl implements VoteService {
    ...
    public PostVoteResponse votePost(Long postId, VoteType newVote) {
        ...
        VoteMessage voteMessage = new VoteMessage(currentUserId,postId,post.getCreator().getUserId(), currentUser.displayUsername(),newVote.toString());
        rabbitTemplate.convertAndSend(RabbitMqConfig.INTERACTION_EXCHANGE, RabbitMqConfig.VOTE_ROUTING_KEY, voteMessage);

        // todo: đưa logic vote saved và single notification -> queue
//        todo:
...
//        }
        ...
        // TODO: notification MQ -> new QUEUE attach to NOTIFICATION Exchange -> sending for each message
